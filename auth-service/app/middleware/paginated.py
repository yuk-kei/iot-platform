...
from app import db
from app.schemas.schemas import StringPaginationSchema, PaginatedCollection


def paginated_response(schema, max_limit=50, order_by=None,
                       order_direction='asc',
    ...
    def inner(f):
        ...
        def paginate(*args, **kwargs):
            ...
            if after is not None:
                ...
                if offset is None:
                    offset = 0
                if offset < 0 or (0 < count <= offset) or limit <= 0:
                    abort(400)
